...
import {
  ...
  ImgCardFriedChicken,
  ImgCharacterMilkTea,
  ImgCharacterFriedChicken,
  ImgFlagsMilkTea,
  ImgFlagsFriedChicken,
} from "../components/ImgExporter";
...
function Home() {
  ...
  return (
    <>
      {isLoading && <Loading />}
      <div
        className={`${blurStyle} noisy-beige relative flex flex-col items-center overflow-hidden`}
      >
        <img
